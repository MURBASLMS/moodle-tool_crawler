...
$string['nextcrawldue'] = 'Next crawl due';
$string['nextcrawlstart'] = 'Next crawl';
$string['nextcrawlstartdesc'] = 'Defines when a new crawl should be started, expressed in natural language eg "next Thursday 7pm". See <a target=_blank href="https://www.php.net/manual/en/datetime.formats.php#datetime.formats.relative">PHP relative dates</a>';
$string['no'] = 'No';
...
$string['reference'] = 'Broken link references';
$string['reference_header'] = '<p>Pages with references to broken URLs. Duplicate URLs will only be searched once.</p>';
